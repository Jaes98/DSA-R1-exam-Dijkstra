...
//   };
//   const visited = new Set();
//   const queue = [{ ...start, distance: 0, priority: 0 }];
//   const directions = [
//     { row: -1, col: 0 },
//     { row: 1, col: 0 },
//     { row: 0, col: -1 },
...
//           const priority = newDistance + heuristic({ row: newRow, col: newCol }, goal);
//           queue.push({ row: newRow, col: newCol, distance: newDistance, priority });
//           previous[`${newRow},${newCol}`] = { row, col };
//         }
//       }
//     }
...
//   createGrid();
//   startButton.addEventListener("click", visualizeAStar);
//   resetButton.addEventListener("click", resetGrid);
//   toggleButton.addEventListener("click", toggleWallMode);
//   speedSlider.addEventListener("input", updateSpeedValue);
//   updateSpeedValue(); // Initialize the speed value display
